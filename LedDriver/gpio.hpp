...
private:
    ...
    #define DISPLAY_TIME_BASE 20
    #define DISPLAY_TIME_SHIFT 0
    /*long time_table[8] = {
    ...
    /*long time_table[8] = {
        DISPLAY_TIME_BASE << (0 + DISPLAY_TIME_SHIFT), //0000 0001 //LSb
        DISPLAY_TIME_BASE << (1 + DISPLAY_TIME_SHIFT), //0000 0010
        DISPLAY_TIME_BASE << (1 + DISPLAY_TIME_SHIFT), //0000 0100
        DISPLAY_TIME_BASE << (2 + DISPLAY_TIME_SHIFT), //0000 1000
        DISPLAY_TIME_BASE << (2 + DISPLAY_TIME_SHIFT), //0001 0000
        DISPLAY_TIME_BASE << (3 + DISPLAY_TIME_SHIFT), //0010 0000
        DISPLAY_TIME_BASE << (3 + DISPLAY_TIME_SHIFT), //0100 0000
        DISPLAY_TIME_BASE << (4 + DISPLAY_TIME_SHIFT), //1000 0000 //MSb
        };*/
    long time_table[8] = {
        DISPLAY_TIME_BASE << (4 + DISPLAY_TIME_SHIFT), //0000 0001 //LSb
        DISPLAY_TIME_BASE << (3 + DISPLAY_TIME_SHIFT), //0000 0010
        DISPLAY_TIME_BASE << (3 + DISPLAY_TIME_SHIFT), //0000 0100
        DISPLAY_TIME_BASE << (2 + DISPLAY_TIME_SHIFT), //0000 1000
        DISPLAY_TIME_BASE << (2 + DISPLAY_TIME_SHIFT), //0001 0000
        DISPLAY_TIME_BASE << (1 + DISPLAY_TIME_SHIFT), //0010 0000
        DISPLAY_TIME_BASE << (1 + DISPLAY_TIME_SHIFT), //0100 0000
        DISPLAY_TIME_BASE << (0 + DISPLAY_TIME_SHIFT), //1000 0000 //MSb
        };
